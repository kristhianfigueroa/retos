    ...
    <div class="span9">
        <div class="table-responsive">
            ...
            $this->beginWidget('zii.widgets.CPortlet', array(
                'title' => '<span class="icons-picture"></span>Operations Chart',
                'titleCssClass' => ''
            ));
            ?>
    ...
    <div class="span3">
        <div class="summary">
            <ul>
                ...
                <li>
            	<span class="summary-icon">
                	<img src="<?php echo $baseUrl; ?>/img/page_white_edit.png" width="36" height="36"
                         alt="Open Invoices">
                </span>
                ...
                <li>
            	<span class="summary-icon">
                	<img src="<?php echo $baseUrl; ?>/img/folder_page.png" width="36" height="36"
                         alt="Recent Conversions">
                </span>
...
<div class="row-fluid">
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => '<span class="icons-th-large"></span>Income Chart',
            'titleCssClass' => ''
        ));
        ?>
    ...
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => '<span class="icons-th-list"></span> Visitors Chart',
            'titleCssClass' => ''
        ));
        ?>
