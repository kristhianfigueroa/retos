...
<div class="page-header">
    <h1>Graphs &amp; Charts -
        <small>Flot and Sparkline</small>
    </h1>
</div>
...
<div class="row-fluid">
    <div class="span9">
        ...
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-user'></i> Live Visitors",
        ));
    ...
    <div class="span3">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-tag'></i> Account Stats",
        ));
...
<div class="row-fluid">
    <div class="span12">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-user'></i> Total Visitors",
        ));
...
<div class="row-fluid">
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-repeat'></i> Bar chart",
        ));
    ...
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-share'></i> Temp",
        ));
...
<div class="row-fluid">
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-pencil'></i> Data Usage",
        ));
    ...
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-arrow-down'></i> Data Usage Monthly",
        ));
...
<div class="row-fluid">
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-tint'></i> Pie Charts",
        ));
    ...
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-adjust'></i> Location Chart",
        ));
...
<div class="row-fluid">
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-check'></i> Other chart",
        ));
    ...
    <div class="span6">
        <?php
        $this->beginWidget('zii.widgets.CPortlet', array(
            'title' => "<i class='icons-info-sign'></i> Pie chart",
        ));
