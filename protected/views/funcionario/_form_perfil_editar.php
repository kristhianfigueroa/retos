...
<div class='row'><!--Fila n-->
    <div class="col-md-4 form-group">
        ...
        echo $form->textField($servidorPublico, 'nombre', array('size' => 60, 'maxlength' => 200,
            'class' => 'input-form'));
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->textField($servidorPublico, 'apellido_paterno', array('size' => 60, 'maxlength' => 200, 'class' => 'input-form'));
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->textField($servidorPublico, 'apellido_materno', array('size' => 60, 'maxlength' => 200, 'class' => 'input-form'));
...
<div class='row'><!--Fila n-->
    <div class="col-md-4 form-group">
        ...
        echo $form->dropDownList($servidorPublico, 'id_cat_dependencia', CatDependencia::comboBox(), array('empty' => 'Seleccionar ..', 'class' => 'input-form'));
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->dropDownList($servidorPublico, 'id_cat_area_dependencia', CatAreaDependencia::comboBox(), array('empty' => 'Seleccionar ..', 'class' => 'input-form'));
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->textField($servidorPublico, 'linkedin', array('size' => 60, 'maxlength' => 500, 'class' => 'input-form'));
...
<div class='row'><!--Fila n-->
    <div class="col-md-4 form-group">
        ...
        echo $form->textField($servidorPublico, 'email', array('size' => 60, 'maxlength' => 200, 'class' => 'input-form'));
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->textField($servidorPublico, 'usuario', array('size' => 60, 'maxlength' => 200, 'class' => 'input-form'));
...
<div class='row'><!--Fila n-->
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->textField($servidorPublico, 'telefono', array('size' => 60, 'maxlength' => 200, 'class' => 'input-form'));
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->dropDownList($servidorPublico, 'id_cat_nivel_acceso', CatNivelAcceso::comboBox(), array('empty' => 'Seleccionar ..', 'class' => 'input-form'));
    ...
    <div class="col-md-4 form-group">
        ...
        echo $form->dropDownList($servidorPublico, 'id_jefe_directo', ServidorPublico::comboBox($servidorPublico->id_servidor_publico), array('empty' => 'Seleccionar ..', 'class' => 'input-form'));
