...
<script type="text/javascript">
    ...
    function getDetalle(idCampo) {
        $.get("index.php?r=CatAreaDependencia/getDetalle", {IdRegistro: idCampo}, function (dato) {
...
<section class="panel">
    <header class="panel-heading">
        <div class="position-center">
            <h4>Administrar Cat Area Dependencia</h4>
        </div>
    </header>
    <div class="panel-body">
        ...
        <div class="table-responsive">
            ...
            'id'=>'cat-area-dependencia-grid',
            'dataProvider' => $catAreaDependencia->search(),
            ...
            'pager'=>array('header'=>''),
            'filter' => $catAreaDependencia,
            'columns' => array(
            		'cat_area_dependencia',
array(
            ...
            'url' => "CHtml::normalizeUrl(array('view', 'id_cat_area_dependencia'=>\$data->id_cat_area_dependencia))",
            ...
            'delete' => array(
            'label' => 'Eliminar',
            'url' => "CHtml::normalizeUrl(array('delete', 'id_cat_area_dependencia'=>\$data->id_cat_area_dependencia))",
            ...
            'update' => array(
            'label' => 'Editar',
            'url' => "CHtml::normalizeUrl(array('update', 'id_cat_area_dependencia'=>\$data->id_cat_area_dependencia))",
