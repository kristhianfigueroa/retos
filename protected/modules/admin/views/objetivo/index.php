...
<script type="text/javascript">
    ...
    function getDetalle(idCampo) {
        $.get("index.php?r=Objetivo/getDetalle", {IdRegistro: idCampo}, function (dato) {
...
<section class="panel">
    ...
    <div class="panel-body">
		...
		'cumplido',
array(
                        'name' => 'id_servidor_publico',

                        'value' => '$data->idServidorPublico->servidor_publico',
                        'filter'=>CHtml::listData(ServidorPublico::model()->findAll(),'id_servidor_publico','servidor_publico')
            ),            array(
            'class' => 'CButtonColumn',
            'template' => '{view}',
            ...
            'url' => "CHtml::normalizeUrl(array('view', 'id_objetivo'=>\$data->id_objetivo))",
            ...
            'delete' => array(
            'label' => 'Eliminar',
            'url' => "CHtml::normalizeUrl(array('delete', 'id_objetivo'=>\$data->id_objetivo))",
            ...
            'update' => array(
            'label' => 'Editar',
            'url' => "CHtml::normalizeUrl(array('update', 'id_objetivo'=>\$data->id_objetivo))",
