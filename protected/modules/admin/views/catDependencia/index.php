...
<?php
/* @var $this CatDependenciaController */
/* @var $catDependencia CatDependencia */
...
<script type="text/javascript">
    ...
    function getDetalle(idCampo) {
        $.get("index.php?r=CatDependencia/getDetalle", {IdRegistro: idCampo}, function (dato) {
...
<section class="panel">
    <header class="panel-heading">
        <div class="position-center">
            <h4>Administrar Cat Dependencia</h4>
        </div>
    </header>
    <div class="panel-body">
        ...
        <div class="table-responsive">
            ...
            'id'=>'cat-dependencia-grid',
            'dataProvider' => $catDependencia->search(),
            ...
            'url' => "CHtml::normalizeUrl(array('view', 'id_cat_dependencia'=>\$data->id_cat_dependencia))",
            ...
            'delete' => array(
            'label' => 'Eliminar',
            'url' => "CHtml::normalizeUrl(array('delete', 'id_cat_dependencia'=>\$data->id_cat_dependencia))",
            ...
            'update' => array(
            'label' => 'Editar',
            'url' => "CHtml::normalizeUrl(array('update', 'id_cat_dependencia'=>\$data->id_cat_dependencia))",
