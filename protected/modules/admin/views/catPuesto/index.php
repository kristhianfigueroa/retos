...
<script type="text/javascript">
    ...
    function getDetalle(idCampo) {
        $.get("index.php?r=CatPuesto/getDetalle", {IdRegistro: idCampo}, function (dato) {
...
<section class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="table-responsive">
            ...
            'url' => "CHtml::normalizeUrl(array('view', 'id_cat_puesto'=>\$data->id_cat_puesto))",
            ...
            'delete' => array(
            'label' => 'Eliminar',
            'url' => "CHtml::normalizeUrl(array('delete', 'id_cat_puesto'=>\$data->id_cat_puesto))",
            ...
            'update' => array(
            'label' => 'Editar',
            'url' => "CHtml::normalizeUrl(array('update', 'id_cat_puesto'=>\$data->id_cat_puesto))",
