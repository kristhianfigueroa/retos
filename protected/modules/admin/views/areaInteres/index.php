...
<script type="text/javascript">
    ...
    function getDetalle(idCampo) {
        $.get("index.php?r=AreaInteres/getDetalle", {IdRegistro: idCampo}, function (dato) {
...
<section class="panel">
    <header class="panel-heading">
        <div class="position-center">
            <h4>Administrar Area Interes</h4>
        </div>
    </header>
    <div class="panel-body">
        ...
        <div class="table-responsive">
            ...
            'id'=>'area-interes-grid',
            'dataProvider' => $areaInteres->search(),
            ...
            'url' => "CHtml::normalizeUrl(array('view', 'id_area_interes'=>\$data->id_area_interes))",
            ...
            'delete' => array(
            'label' => 'Eliminar',
            'url' => "CHtml::normalizeUrl(array('delete', 'id_area_interes'=>\$data->id_area_interes))",
            ...
            'update' => array(
            'label' => 'Editar',
            'url' => "CHtml::normalizeUrl(array('update', 'id_area_interes'=>\$data->id_area_interes))",
